...
Install `pip install uncompyle6`, run it to decompile code, output to snake.py we have the code
...
# Compiled at: 2022-01-18 05:16:46
...
This is python2, run it with `python2 snake.py` and enjoy text-based snake game.

Use `dis.dis` to decompile, we see the flag:
